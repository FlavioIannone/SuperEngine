...
namespace SuperEngine
{
    ...
    {
        // Phase 1: Call OnDestroy() on components pending destruction while they are still safely allocated in memory.
        for (auto &comp : m_components)
        {
        ...
        // Phase 2: Physically remove the components from the list.
